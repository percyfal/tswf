...
parser.add_argument("tree_sequence", help="The tree sequence to load in .trees format")
parser.add_argument("sample", help="The sample for which to calculate data")
parser.add_argument(
...
parser.add_argument("--output-file", help="output file name", default=sys.stdout)
parser.add_argument(
...
parser.add_argument("--end-pos", help="windows end position", default=None, type=int)
parser.add_argument("--haplotype", help="windows end position", default=0, type=int)
