...
inputvcf = snakemake.input.vcf  # noqa: F821
inputcsi = snakemake.input.csi  # noqa: F821
df_meta = snakemake.params.samples  # noqa: F821
df_pop = snakemake.params.populations  # noqa: F821
chrom = snakemake.wildcards.chrom  # noqa: F821
chromlength = snakemake.params.length  # noqa: F821
tsout = snakemake.output.trees  # noqa: F821
...
ts = tsinfer.infer(
    samples, progress_monitor=True, num_threads=snakemake.threads  # noqa: F821
)
